...
// const quantity2 = document.getElementById("quantity-product");
// var quantityParsedInt = parseInt(quantity2.innerHTML);

// document.querySelector('.button-dec').addEventListener("click", function() {
//     quantityParsedInt -= 1;
//     quantity2.innerHTML = quantityParsedInt;
// });
// document.querySelector('.button-inc').addEventListener("click", function() {
//     quantityParsedInt += 1;
//     quantity2.innerHTML = quantityParsedInt;
// });
